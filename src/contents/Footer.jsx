...
export default function Footer() {
  return (
    <footer class="flex flex-auto gap-6 justify-center items-center mt-2    bg-indigo-950 text-amber-50  max-md:flex-col max-md:items-start max-md:p-8 max-md:h-auto">
